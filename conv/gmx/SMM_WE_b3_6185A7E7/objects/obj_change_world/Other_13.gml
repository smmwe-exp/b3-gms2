var mundos, _wrapper, _list, _map, _list2, j, _map2, o_ground, _list3, k, _map3, object, o_objecto, _list4, l, _map4, _list5, _map5, sprite, _list6, _map6, _list7, _map7, _list8, _map8, _list9, _map9;
if file_exists((global.directorio_temporal + "nivel_temporal.swet"))
{
    ...
    for (l = 0; l < ds_list_size(_list9); l++)
    {
        ...
        object = asset_get_index(ds_map_find_value(_map9, "object"))
        o_objecto = instance_create(0, 0, object)
        o_objecto.x = ds_map_find_value(_map9, "x_pos")
        o_objecto.y = ds_map_find_value(_map9, "y_pos")
        o_objecto.x_draw = ds_map_find_value(_map9, "x_pos")
        o_objecto.y_draw = ds_map_find_value(_map9, "y_pos")
    }
