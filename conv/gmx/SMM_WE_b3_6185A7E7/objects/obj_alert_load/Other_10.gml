...
if (myfile != "")
{
    if file_exists((global.directorio + myfile))
    {
        global.save_changes = (global.directorio + myfile)
        global.last_level = myfile
        global.levelguardabot = global.last_level
        mundos = LoadJSONFromFile((global.directorio + myfile))
