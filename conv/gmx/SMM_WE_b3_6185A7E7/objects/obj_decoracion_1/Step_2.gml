if (obj_levelmanager.editor == 1)
{
    if (global.apariencia == 0)
    {
        if (global.modo_noche == 1)
            sprite_index = spr_SMB_decoracion_1_night
        else
            sprite_index = spr_SMB_decoracion_1
    }
    else if (global.apariencia == 1)
    {
        if (global.modo_noche == 1)
            sprite_index = spr_SMB3_decoracion_1_night
        else
            sprite_index = spr_SMB3_decoracion_1
    }
    else if (global.apariencia == 2)
    {
        if (global.modo_noche == 1)
            sprite_index = spr_decoracion_1_night
        else
            sprite_index = spr_decoracion_1
    }
