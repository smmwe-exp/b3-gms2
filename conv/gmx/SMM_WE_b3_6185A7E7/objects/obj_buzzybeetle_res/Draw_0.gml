...
if (paracaidas == 1)
    draw_sprite_ext(p_sprite, global.apariencia, (x_draw + para_x), (y_draw - para_y), s_scalex, s_scaley, 1, c_white, 1)
if (inup == 1)
    draw_sprite_ext(sprite_index, image_index, x_draw, (y_draw + 16), 1, -1, 0, c_white, 1)
else
    draw_sprite_ext(sprite_index, image_index, x_draw, y_draw, s_scalex, s_scaley, rotacion, c_white, 1)
if (wings == 1)
    draw_sprite_ext(w_sprite, global.apariencia, (x_draw + wings_x), (y_draw - wings_y), s_scalex, s_scaley, 1, c_white, 1)
