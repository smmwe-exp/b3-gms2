...
if (inup == 1)
    draw_sprite_ext(sprite_index, image_index, (x_draw + 16), (y_draw + 16), 1, 1, 180, c_white, 1)
else
    draw_sprite_ext(sprite_index, image_index, x_draw, y_draw, image_xscale, 1, 0, c_white, 1)
