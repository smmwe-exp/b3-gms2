...
{
    if (drop_lock == 1)
        draw_sprite_ext(grid_selected, 1, (floor(((mouse_x + calculo_x) / 16)) * 16), (floor(((mouse_y + calculo_y) / 16)) * 16), image_xscale, size_y, 0, c_white, 1)
    else
        draw_sprite_ext(grid_selected, 0, (floor(((mouse_x + calculo_x) / 16)) * 16), (floor(((mouse_y + calculo_y) / 16)) * 16), image_xscale, size_y, 0, c_white, 1)
}
