...
if instance_exists(obj_bowser_big)
{
    with (obj_bowser_big)
    {
        alarm[10] = 1
...
if instance_exists(obj_boomboom_big)
{
    with (obj_boomboom_big)
        alarm[10] = 1
}
...
if instance_exists(obj_onewaygate)
{
    with (obj_onewaygate)
        image_speed = 0.15
}
if instance_exists(obj_SMB3_pplant)
{
    with (obj_SMB3_pplant)
    {
        image_speed = 0.15
        alarm[10] = -1
        hspeed = 0
...
if instance_exists(obj_platform_moving)
{
...
if instance_exists(obj_thwomp_big)
{
    with (obj_thwomp_big)
        image_speed = 0
}
