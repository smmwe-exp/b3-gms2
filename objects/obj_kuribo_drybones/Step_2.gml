...
if instance_exists(obj_mario)
{
    ...
    if (collision_rectangle(bbox_left, (bbox_bottom + 8), bbox_right, (bbox_bottom + vspeed), obj_lava_water_drybones, 0, 0) && (instance_exists(obj_mario) && (instance_exists(obj_lava_water) && ((obj_mario.y < (obj_lava_water.y - 28)) && (obj_mario.state == 1)))))
    {
        ...
        if ((global.bg_level == "forest") && (global.apariencia == 2))
        {
    ...
    {
        if (((global.bg_level == "underwater") || (instance_exists(obj_lava_water) && ((y >= (obj_lava_water.y + 16)) && ((global.bg_level == "forest") && (global.modo_noche == 0))))) && (global.apariencia != 0))
        {
            obj_mario.vspeed = -1
    ...
    if ((obj_mario.state == 2) && ((!collision_rectangle(bbox_left, (bbox_top + 4), bbox_right, (bbox_bottom - 1), obj_bortice, 0, 0)) && keyboard_check_pressed(global.abajo)))
    {
    ...
    if ((obj_mario.state == 2) && (collision_rectangle(bbox_left, (bbox_top + 4), bbox_right, (bbox_bottom - 1), obj_bortice, 0, 0) && (gran_golpe == 1)))
        gran_golpe = 0
    if ((stateprev == 2) && ((obj_mario.state != 2) && (!collision_rectangle(bbox_left, (bbox_bottom + 8), bbox_right, (bbox_bottom + vspeed), obj_lava_water_drybones, 0, 0))))
    {
        if ((gran_golpe == 1) && (golpe_count == 0))
        {
            ...
            block = collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_blockparent, 0, 0)
            if block
            {
                with (block)
                {
...
else if instance_exists(obj_player_goal_smb3)
{
    ...
    obj_player_goal_smb3.visible = 0
    m_sprite = scr_mario_drybones()
    m_subimagen = 0
    image_speed = 0
    image_index = 0
...
else if instance_exists(obj_player_goal_smw_castle)
{
    ...
    obj_player_goal_smw_castle.visible = 0
    m_sprite = scr_mario_drybones()
    m_subimagen = 0
    image_speed = 0
    image_index = 0
